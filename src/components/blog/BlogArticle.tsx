  ...
  return (
    <article className="pb-20 pt-36 md:pb-28 md:pt-44">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        {/* Tek ızgara: sol ray (içindekiler) yazının EN BAŞINDAN itibaren
        ...
        <div className="grid gap-10 lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-16">
          ...
          <div className="min-w-0 max-w-3xl">
            ...
            {post.image && <figure className="mt-10"><Image src={post.image.src} alt={post.image.alt} width={post.image.width} height={post.image.height} sizes="(max-width: 767px) 100vw, 768px" priority className="h-auto w-full rounded-2xl" /></figure>}
            <div className="mt-12 border-t border-surface-100 pt-10">
